...
export const editorRoutes: EditorRouteDefinition[] = [
  ...
  { id: RouteEnum.textureAtlases, label: "Texture Atlases", section: "Tools", hint: "Pack sprites for runtime" },
  { id: RouteEnum.texturePacking, label: "Material Packing", section: "Tools", hint: "Pack GPPT material channels" },
