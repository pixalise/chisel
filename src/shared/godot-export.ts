...
import { AssetCategoryEnum, InputKeyEnum } from "./types";
...
function renderManifest(project: Project, exportedAt: string, tables: GodotTableExport[], assets: Asset[]): GodotExportFile {
