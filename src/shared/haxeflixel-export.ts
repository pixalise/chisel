...
function renderTable(table: AnyDataTable, context: HaxeValueContext): HaxeFlixelExportFile {
  ...
  return {
    path: `${HAXEFLIXEL_GAME_DATA_EXPORT_ROOT}/${className}.hx`,
...
function renderLocalization(localization: LocalizationDocument): HaxeFlixelExportFile {
  ...
  return {
    path: `${HAXEFLIXEL_GAME_DATA_EXPORT_ROOT}/ChiselLocalization.hx`,
...
function renderManifest(
  ...
  return {
    path: `${HAXEFLIXEL_GAME_DATA_EXPORT_ROOT}/ChiselManifest.hx`,
...
export function createHaxeFlixelExportBundle(
  ...
  return {
    files: [
      ...
      ...renderHaxeFlixelInputExport(tables, HAXEFLIXEL_GAME_DATA_EXPORT_ROOT),
      renderAssets(assets),
