...
electron_1.contextBridge.exposeInMainWorld("electron", {
    ...
    packBase: (input) => electron_1.ipcRenderer.invoke("terrain:pack-base", input),
    packSurface: (input) => electron_1.ipcRenderer.invoke("terrain:pack-surface", input),
    savePackedTerrainAsset: (input) => electron_1.ipcRenderer.invoke("terrain:save-packed-asset", input),
