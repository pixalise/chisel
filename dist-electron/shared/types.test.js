...
(0, vitest_1.describe)("asset categories", () => {
    (0, vitest_1.it)("includes HDRI as a selectable asset category", () => {
        ...
        (0, vitest_1.expect)(types_1.assetCategoryLabelMap[types_1.AssetCategoryEnum.uiIcon]).toBe("UI Icon");
        (0, vitest_1.expect)(types_1.assetCategoryOptionValues).toContainEqual({ label: "UI Icon", value: types_1.AssetCategoryEnum.uiIcon });
    });
